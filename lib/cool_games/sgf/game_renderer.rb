  ...
  module Sgf
    class GameRenderer < Renderer
      ...
      def render game
        ...
        sgf << render_property("PW", game.white_player.cancan.name)
        sgf << render_property("WR", game.white_player.cancan.rank)
        sgf << render_property("PB", game.black_player.cancan.name)
        sgf << render_property("BR", game.black_player.cancan.rank)
